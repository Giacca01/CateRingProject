...
public class Menu {
    ...
    private ObservableList<ServiceInfo> usedIn;

    private User owner;

    private Menu() {
        this.featuresMap = FXCollections.observableHashMap();
        this.usedIn = FXCollections.observableArrayList();
    }
    ...
    public ObservableList<Recipe> getRecipes(){
        ...
        for (Section s: this.sections) {
            recipes.addAll(s.getSectionRecipes());
        }
        return recipes;
    }

    public ObservableList<ServiceInfo> getUsedIn(){
        return this.usedIn;
    }
