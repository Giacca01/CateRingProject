...
INSERT INTO `Services` VALUES (1,2,'Cena',86,0,'2020-08-13','20:00:00','23:30:00',25),(2,1,'Coffee break mattino',0,86,'2020-09-25','10:30:00','11:30:00',100),(3,1,'Colazione di lavoro',0,0,'2020-09-25','13:00:00','14:00:00',80),(4,1,'Coffee break pomeriggio',0,82,'2020-09-25','16:00:00','16:30:00',100),(5,1,'Cena sociale',0,0,'2020-09-25','20:00:00','22:30:00',40),(6,3,'Pranzo giorno 1',0,0,'2020-10-02','12:00:00','15:00:00',200),(7,3,'Pranzo giorno 2',0,0,'2020-10-03','12:00:00','15:00:00',300),(8,3,'Pranzo giorno 3',0,0,'2020-10-04','12:00:00','15:00:00',400);
...
INSERT INTO `KitchenTasks` VALUES (1, 'KithenTask1'),(2, 'KitchenTask2'),(3, 'KitchenTask3'),(4, 'KitchenTask4');
/*!40000 ALTER TABLE `KitchenTasks` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `AssignmentKitchenTasks`
--
DROP TABLE IF EXISTS `AssignmentKitchenTasks`;
CREATE TABLE `AssignmentKitchenTasks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `assignment_id` int(11) NOT NULL,
  `kitchentask_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
);

--
-- Table structure for table `RecipesKitchenTasks`
--
DROP TABLE IF EXISTS `RecipesKitchenTasks`;
CREATE TABLE `RecipesKitchenTasks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `recipe_id` int(11) NOT NULL,
  `kitchentask_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
LOCK TABLES `RecipesKitchenTasks` WRITE;
/*!40000 ALTER TABLE `RecipesKitchenTasks` DISABLE KEYS */;
INSERT INTO `RecipesKitchenTasks` VALUES (1, 1, 1),(2, 2, 1),(3, 3, 2),(4, 5, 2),(5, 20, 3),(6, 8, 3),(7, 18, 4),(8, 19, 4);
/*!40000 ALTER TABLE `RecipesKitchenTasks` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Shift` VALUES (1, false),(2, false),(3, false),(4, false);
...
--
-- Table structure for table `ShiftAvailability`
--
DROP TABLE IF EXISTS `ShiftAvailability`;
